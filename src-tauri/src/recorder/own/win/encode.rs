...
//! textures into a fragmented MP4. Ported from
//! `spikes/p0c-video/src/win/encode.rs`, video only.
//!
//! **The sink writer is this piece's path, not the final one.** Media
//! Foundation's MP4 sinks hold one audio stream, so WS1.6.7 (#239) replaces
//! this with the encoder driven directly and `mp4::write` doing the muxing
...
use windows::Win32::Media::MediaFoundation::{
    ...
    IMFMediaType, IMFSample, IMFSinkWriter, IMFSinkWriterEx, IMFTransform, MF_MT_AVG_BITRATE,
    MF_MT_FRAME_RATE, MF_MT_FRAME_SIZE, MF_MT_INTERLACE_MODE, MF_MT_MAJOR_TYPE,
    MF_MT_PIXEL_ASPECT_RATIO, MF_MT_SUBTYPE, MF_READWRITE_ENABLE_HARDWARE_TRANSFORMS,
    MF_SINK_WRITER_D3D_MANAGER, MF_TRANSCODE_CONTAINERTYPE, MFCreateAttributes,
    MFCreateDXGIDeviceManager, MFCreateDXGISurfaceBuffer, MFCreateMediaType,
    MFCreateSinkWriterFromURL, MFCreateTrackedSample, MFMediaType_Video,
...
/// A sink writer with one H.264 stream, writing a fragmented MP4.
pub struct Sink {
